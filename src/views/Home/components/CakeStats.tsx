...
const CakeStats = () => {
  ...
  let cornPerBlock = 0;
  if(farms && farms[0] && farms[0].cornPerBlock){
    cornPerBlock = new BigNumber(farms[0].cornPerBlock).div(new BigNumber(10).pow(18)).toNumber();
  }
    ...
    <StyledCakeStats>
      <CardBody>
        ...
        <Row>
          ...
          <Text bold fontSize="14px" color="#FFFFFF">{cornPerBlock}</Text>
        </Row>
      </CardBody>
    </StyledCakeStats>
  )
